...
# Save the best model
dump(best_lgb_model, 'lightgbm_model_balanced_smote_best_7.joblib')
...
save_roc_curve_data_with_predictions(best_lgb_model, X_test_filled, y_test, 'roc_curve_lightgbm_test_7.csv')
