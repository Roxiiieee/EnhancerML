...
# Save the best model
dump(best_logreg_model, 'logistic_regression_model_balanced_smote_31.joblib')
...
save_roc_curve_data_with_predictions(best_logreg_model, X_test_filled, y_test, 'roc_curve_log_reg_test.csv')
