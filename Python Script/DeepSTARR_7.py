...
}, 'deepstarr_model_optuna_seven_features.pth')
...
thresholds = save_roc_curve_data_with_predictions(best_model, test_loader, test_data, 'roc_curve_deepstarr_test_7_features_optuna.csv')
