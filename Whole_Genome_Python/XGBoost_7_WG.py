...
xgb_model = load('xgboost_model_balanced_smote_best_7.joblib')
...
save_roc_curve_data_with_predictions(xgb_model, X_new_filled_pd, y_new_pd, new_data.compute(), 'roc_curve_xgboost_whole_genome_7.csv')