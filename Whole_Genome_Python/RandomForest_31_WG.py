...
rf_model = load('random_forest_model_balanced_smote_best.joblib')
...
save_roc_curve_data_with_predictions(rf_model, X_new_filled_pd, y_new_pd, new_data.compute(), 'roc_curve_random_forest_whole_genome_31.csv')