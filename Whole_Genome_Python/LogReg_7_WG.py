...
log_reg = load('logistic_regression_model_balanced_smote_7.joblib')
...
# Compute and save ROC curve data for the Logistic Regression model on new data
save_roc_curve_data_with_predictions(log_reg, X_new_filled_pd, y_new_pd, new_data.compute(), 'roc_curve_log_reg_whole_genome_7.csv')